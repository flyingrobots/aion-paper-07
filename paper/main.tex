...
\begin{figure}[H]
	...
	\begin{tikzpicture}[x=1cm,y=1cm]
		\tikzset{
			warp seam/.style={warp box, minimum width=3.0cm, minimum height=1.05cm, font=\small},
			warp seam shell/.style={warp shell, minimum width=3.0cm, minimum height=1.05cm, font=\small}
		}

		\node[warp seam] (sdl) at (0,0) {Authored optic boundary\\(SDL)};
		\node[warp seam] (compiler) at (4.0,0) {Schema compiler};
